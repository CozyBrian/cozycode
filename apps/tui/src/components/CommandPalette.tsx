...
export type Command = "new" | "clear" | "help" | "quit";
...
export function CommandPalette({ onSelect }: { onSelect: (command: Command) => void }) {
  return (
    <box justifyContent="center" marginY={1}>
      <box flexDirection="column" width={42} height={8} borderStyle="rounded" borderColor={theme.borderActive} backgroundColor={theme.panel} paddingX={2} paddingY={1}>
