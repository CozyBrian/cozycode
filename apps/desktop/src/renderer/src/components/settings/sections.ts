...
import { FolderOpen, KeyRound, Keyboard, Palette, Shield, SlidersHorizontal, TerminalSquare } from "lucide-react";
...
export const SETTINGS_SECTIONS: Array<{ id: SettingsSection; label: string; description: string; icon: LucideIcon }> = [
  ...
  { id: "keyboard", label: "Keyboard", description: "Customize application-wide shortcuts.", icon: Keyboard },
